...
import net.sldt_team.doc.logging.ConsoleHandlerFormator;
import net.sldt_team.doc.logging.OutputStreamToLogger;
...
public class Main {
    ...
    public static final Logger log = Logger.getLogger("EngineDoc");
